...
interface HospitalSWErrorStateProps {
  title?: string;
  message: string;
  description?: string;
  action?: {
...
/**
 * Reusable error state component for hospital social worker pages
 * Provides consistent error UI across the application
 */
export function HospitalSWErrorState({
  title = "Error",
  message,
  description,
  action,
