...
interface HospitalSWDetailHeaderProps {
  title: string;
  subtitle?: string;
  backLabel?: string;
  backPath?: string;
...
/**
 * Reusable detail page header component for Hospital SW pages
 * Provides consistent header UI with back button, title, badges, and actions
 */
export function HospitalSWDetailHeader({
  title,
  subtitle,
  backLabel = "Back",
  backPath,
