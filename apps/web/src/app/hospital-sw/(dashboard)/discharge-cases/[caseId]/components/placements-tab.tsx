...
export function PlacementsTab({
  ...
  // Check if there are any providers who have accepted
  const hasAcceptedProviders = invitations.some((inv) => inv.response === "ACCEPTED");
          ...
          {placements.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground mb-4">
                {hasAcceptedProviders
                  ? "Create a placement from one of the providers who accepted the invitation."
                  : "Wait for providers to accept invitations before creating a placement."}
              </p>
              {hasAcceptedProviders && (
                <Button
                  variant="healthcare"
