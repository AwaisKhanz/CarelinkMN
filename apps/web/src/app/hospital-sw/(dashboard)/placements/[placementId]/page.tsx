...
// Import read-only tab components (we'll reuse provider components but in read-only mode)
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Read-only view of placement information
            </p>
          </div>
        </div>
      ...
      {placement.dischargeCase && (
        <Card variant="healthcare">
          <CardHeader>
            ...
            <CardDescription>
              Information from discharge case
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div>
                ...
                <p className="font-medium">{placement.dischargeCase.patientGender}</p>
              </div>
              <div>
