  ...
  return (
    <div className="space-y-6">
      ...
      <Card
        ...
        className={cn(
          "border-l-4",
          opening.status === OpeningStatus.OPEN && "border-l-success",
          opening.status === OpeningStatus.PENDING && "border-l-warning",
          opening.status === OpeningStatus.FILLED && "border-l-info",
          opening.status === OpeningStatus.EXPIRED && "border-l-muted"
        )}
      >
        <CardContent className="pt-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <StatusIcon
                className={cn("w-6 h-6", `text-${statusConfig.color}`)}
              />
              <div>
