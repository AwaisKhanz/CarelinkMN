...
function ProviderResidentsPageContent() {
  ...
  const { homes, isLoading: homesLoading } = useProviderHomes();
...
function ProviderResidentsPageWrapper() {
  ...
  return (
    <ProviderSubscriptionGuard
      ...
      feature={residentsGate.feature}
      featureDescription={residentsGate.description}
    >
      <ProviderResidentsPageContent />
    </ProviderSubscriptionGuard>
  );
}
