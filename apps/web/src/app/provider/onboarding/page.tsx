...
export default function ProviderOnboardingPage() {
  ...
  useEffect(() => {
    const loadOnboardingState = async () => {
      try {
        ...
        toast.success("Onboarding state loaded successfully");
      } catch (error) {
  ...
  const handleStepComplete = (stepData: any) => {
    ...
    // Auto-save with completion flag
    saveStepData(currentStep, stepData, true);
  };
  ...
  const handleStepDataChange = useCallback(
    (stepData: any) => {
      ...
      // Auto-save without completion flag (debounced)
      debounceTimeoutRef.current = setTimeout(() => {
        saveStepData(currentStep, stepData, false);
            ...
            <div className="flex items-center gap-2">
              {currentStep < STEPS.length - 1 ? (
                ...
                <Button
                  ...
                  disabled={
                    !completedSteps.includes(currentStep) || isSubmitting
                  }
                  className="flex items-center gap-2"
                >
                  {isSubmitting ? (
