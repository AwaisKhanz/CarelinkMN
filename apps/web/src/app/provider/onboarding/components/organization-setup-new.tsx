...
import { Building2, MapPin, Phone, Mail, Globe, CheckCircle } from "lucide-react";
...
export function OrganizationSetup({ data, onComplete, onChange }: OrganizationSetupProps) {
  const [formData, setFormData] = useState({
    organizationName: data?.organizationName || "",
    organizationType: data?.organizationType || "PROVIDER",
  ...
  const validateForm = () => {
    ...
    if (!formData.primaryLicenseType.trim()) {
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handleInputChange("primaryLicenseType", e.target.value)}
              placeholder="e.g., 144D, 245D, CRS, ALF"
              className={errors.primaryLicenseType ? "border-destructive" : ""}
            />
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Describe your organization and the services you provide..."
              rows={4}
